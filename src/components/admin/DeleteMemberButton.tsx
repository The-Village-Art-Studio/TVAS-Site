      ...
      {showConfirm && (
        ...
        >
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full border border-slate-200 animate-in zoom-in-95 duration-200">
            ...
            {/* Content */}
            <h3 className="text-xl font-black text-slate-900 mb-2">Delete Artist Profile</h3>
            <p className="text-slate-500 font-medium mb-1">
              You are about to permanently delete:
            </p>
            <p className="font-black text-slate-900 text-lg mb-6">"{name}"</p>
            <p className="text-sm text-slate-400 mb-8">
              This action cannot be undone. The profile will be removed from the public directory immediately.
            </p>
