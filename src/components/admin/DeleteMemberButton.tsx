  ...
  return (
    <>
      ...
      <button
        ...
        className="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-red-600 hover:text-white hover:border-red-600 shadow-lg transition-all"
        title="Delete Member"
      >
        <Trash2 size={16} />
      </button>
      ...
      {showConfirm && mounted && createPortal(
        ...
        >
          ...
          <div className="relative bg-white rounded-[2.5rem] shadow-2xl p-10 max-w-md w-full border border-slate-200 animate-in zoom-in-95 fade-in duration-300">
            ...
            {/* Content */}
            <h3 className="text-2xl font-black text-slate-900 mb-3 tracking-tight uppercase">Delete Artist Profile</h3>
            <p className="text-slate-500 font-medium mb-1">
              You are about to permanently delete:
            </p>
            <p className="font-black text-blue-600 text-xl mb-8">"{name}"</p>
            ...
            <div className="p-5 bg-red-50/50 rounded-2xl border border-red-100 mb-10">
              <p className="text-sm text-red-700 font-bold leading-relaxed flex gap-3">
                ...
                This action is irreversible. All portfolio data, statements, and images for this artist will be wiped from the server.
              </p>
            </div>
